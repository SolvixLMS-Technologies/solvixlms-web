...
const SUITES = [
  {
    ...
    desc: "Every wash, dry, collection, and press — captured per batch with parameter-level depth. Queryable across strains, technicians, and time. Institutional knowledge that compounds instead of evaporating.",
    features: [
      "Batch-level tracking across wash, dry, collect, press, and cure stages",
      "Wash temperature curves and micron fraction yields",
      "Press profile capture with technician attribution",
      "Real-time session monitoring with KPI dashboards",
      "Cross-batch strain performance comparison",
    ],
  },
  {
    id: "comp" as IconName,
  ...
  },
  {
    ...
    desc: "Track what you spend to produce what you sell. Bags, screens, solvents, packaging — tied to the batch that consumed them, down to cost-per-gram.",
    features: [
      "Consumable inventory with burn-rate tracking",
      "Cost-per-gram calculation per batch and per strain",
  ...
  },
  {
    ...
    desc: "The only analytics engine trained on how you actually produce. Cost trends, yield curves, strain profiles, technician performance — from your own runs, not industry averages.",
    features: [
      "Yield trending by strain, technician, and time period",
